...
export default function OrangeCountyPage() {
  return (
    <>
      <AreaPageTracker areaType="county" areaName="Orange County" />
      ...
      <section className="section-padding bg-offwhite">
        <div className="container-max">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {cities.map((city) => (
              <Link key={city.name} href={`/areas/orange-county/${city.name.toLowerCase().replace(/\s+/g, "-")}`}>
      ...
      <section className="section-padding bg-primary">
        <div className="container-max text-center">
          <h2 className="text-3xl md:text-4xl font-serif text-white mb-6">
            How BabyHomePlan Helps in Orange County
          </h2>
