        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-body-secondary leading-relaxed">
              BabyHomePlan.com is a licensed real estate brokerage in the State of California.
            </p>
          ...
          <div>
            ...
            <p className="text-body-secondary leading-relaxed">
              ...
              BabyHomePlan primarily provides buyer representation. Before entering into a representation
          ...
          <div>
            ...
            <p className="text-body-secondary leading-relaxed">
              BabyHomePlan coordinates with third-party service providers (lenders, inspectors, contractors)
              for your convenience. These are independent businesses and BabyHomePlan does not guarantee
          ...
          <div>
            ...
            <p className="text-body-secondary leading-relaxed">
              If BabyHomePlan has any financial interest in or receives compensation from any recommended
